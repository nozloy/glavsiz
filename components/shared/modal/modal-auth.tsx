...
export const ModalAuth: React.FC<Props> = ({ open, onClose }) => {
	...
	return (
		<Dialog open={open} onOpenChange={handleClose}>
			<DialogContent className='w-[350px] bg-white p-10'>
				<DialogTitle>Выберите способ входа:</DialogTitle>
				<hr />
				<div className='flex flex-col gap-2'>
					<Button
						...
						onClick={() => signIn('vk')}
						type='button'
						className='gap-2 h-12 p-2 flex-1 text-2xl font-semibold bg-slate-800 hover:bg-[#0077FF] text-white rounded-md'
					>
						Войти с VK ID
						<svg
							width='32'
           ...
           17.5682 18.8875 19.31H21.4939C20.7869 16.7044 18.9535 15.2604 17.8141 14.71C18.9526 14.0293 20.5641 12.3893 20.9436 10.15H18.5722C18.0747 11.971 16.5945 13.6233 15.1803 13.78V10.15H12.7711V16.5C11.305 16.1337 9.39237 14.3538 9.314 10.15H6.79999Z'
					...
					<Button
						...
						type='button'
						className='gap-2 h-12 p-2 flex-1 text-white hover:bg-red-600 border bg-slate-800'
					>
						<svg
							width='127'
							height='30'
